if ("undefined" == typeof jQuery) throw new Error("datetimepicker error.");
if (+ function(a) {
    var b = a.fn.jquery.split(" ")[0].split(".");
    if (b[0] < 2 && b[1] < 9 || 1 === b[0] && 9 === b[1] && b[2] < 1 || b[0] >= 4) throw new Error("datetimepicker requires at least jQuery v3.0.0 but less than v4.0.0")
}(jQuery), "undefined" == typeof moment) throw new Error("datetimepicker requires moment.js. Moment.js must be included before Tempus Dominus Bootstrap4's JavaScript.");
var version = moment.version.split(".");
if (version[0] <= 2 && version[1] < 17 || version[0] >= 3) throw new Error("datetimepicker Bootstrap4's requires at least moment.js v2.17.0 but less than v3.0.0"); + function() {
    function a(a, b) {
            ...
            var d = "datetimepicker",
                ...
                r = {
                    ...
                    icons: {
                        ...
                        previous: "fas fa-angle-left action-item__icon",
                        next: "fas fa-angle-right action-item__icon",
        ...
        var g = e.fn[f.NAME],
            ...
            l = function(g) {
                ...
                return b(k, g), k.prototype._init = function() {
                    ...
                    //var a = e("<thead>").append(e("<tr>").addClass("datepicker__controls").append(e("<th>").addClass("prev").attr("data-action", "previous").append(e("<span>").addClass(this._options.icons.previous))).append(e("<th>").addClass("picker-switch").attr("data-action", "pickerSwitch").attr("colspan", "" + (this._options.calendarWeeks ? "6" : "5"))).append(e("<th>").addClass("next").attr("data-action", "next").append(e("<span>").addClass(this._options.icons.next)))),
                    var a = e("<div>").addClass("datepicker__controls action-item--condensed").append(e("<div>").addClass("action-item action-item--light").append(e("<i>").addClass(this._options.icons.previous).attr("data-action", "previous"))).append(e("<div>").addClass("picker-switch").attr("data-action", "pickerSwitch")).append(e("<div>").addClass("action-item action-item action-item--light").attr("data-action", "next").append(e("<i>").addClass(this._options.icons.next))),
                        b = e("<tbody>").append(e("<tr>").append(e("<td>").attr("colspan", "" + (this._options.calendarWeeks ? "8" : "7"))));
                    //return [e("<div>").addClass("datepicker-days").append(e("<table>").addClass("table").append(a).append(e("<tbody>"))), e("<div>").addClass("datepicker-months").append(e("<table>").addClass("table-condensed").append(a.clone()).append(b.clone())), e("<div>").addClass("datepicker-years").append(e("<table>").addClass("table-condensed").append(a.clone()).append(b.clone())), e("<div>").addClass("datepicker-decades").append(e("<table>").addClass("table-condensed").append(a.clone()).append(b.clone()))]
                    return [e("<div>").addClass("datepicker-days").append(a).append(e("<table>").addClass("table").append(e("<thead>"),e("<tbody>"))), e("<div>").addClass("datepicker-months").append(a.clone()).append(e("<table>").addClass("table").append(b.clone())), e("<div>").addClass("datepicker-years").append(a.clone()).append(e("<table>").addClass("table").append(b.clone())), e("<div>").addClass("datepicker-decades").append(e("<table>").addClass("table-condensed").append(a.clone()).append(b.clone()))]
                    ...
                    }).addClass("btn btn-text--blue").attr("data-action", "incrementHours").append(e("<span>").addClass(this._options.icons.up)))), b.append(e("<td>").append(e("<span>").addClass("timepicker-hour").attr({
                    ...
                    }).addClass("btn btn-text--blue").attr("data-action", "decrementHours").append(e("<span>").addClass(this._options.icons.down))))), this._isEnabled("m") && (this._isEnabled("h") && (a.append(e("<td>").addClass("separator")), b.append(e("<td>").addClass("separator").html(":")), c.append(e("<td>").addClass("separator"))), a.append(e("<td>").append(e("<a>").attr({
                        href: "#",
                        tabindex: "-1",
                        title: this._options.tooltips.incrementMinute
                    }).addClass("btn btn-text--blue").attr("data-action", "incrementMinutes").append(e("<span>").addClass(this._options.icons.up)))), b.append(e("<td>").append(e("<span>").addClass("timepicker-minute").attr({
                    ...
                    }).addClass("btn btn-text--blue").attr("data-action", "decrementMinutes").append(e("<span>").addClass(this._options.icons.down))))),
                    ...
                    }).addClass("btn btn-text--blue").attr("data-action", "incrementSeconds").append(e("<span>").addClass(this._options.icons.up)))), b.append(e("<td>").append(e("<span>").addClass("timepicker-second").attr({
                    ...
                    }).addClass("btn btn-text--blue").attr("data-action", "decrementSeconds").append(e("<span>").addClass(this._options.icons.down))))), this.use24Hours || (a.append(e("<td>").addClass("separator")), b.append(e("<td>").append(e("<a>").addClass("btn btn-text--blue").attr({
                    ...
                    var a = this.widget.find(".datepicker-months"),
                        //b = a.find("th"),
                        b = a.find(".datepicker__controls").children(),
