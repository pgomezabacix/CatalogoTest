			...
			if (settings.title) {
				headerHtml = (
					'<div id="' + id + '-head" class="' + prefix + 'window-head">' +
						...
						'<button type="button" class="p-0 action-item action-item--sm ' + prefix + 'close" aria-hidden="true">&times;</button>' +
...
define("tinymce/Editor", [
	...
	Editor.prototype = {
					...
					if (plugin && !PluginManager.urls[plugin]) {
						if (plugin.charAt(0) == '-') {
							...
							PluginManager.load(plugin, {
								prefix: 'plugins/',
								resource: plugin,
								//suffix: '/plugin' + suffix + '.min.js'
								suffix: '/plugin.min.js'
							});
						}
					}
				});
		...
		init: function() {
			...
			self.iframeHTML = settings.doctype + '<html style="height:100%"><head>';
		...
		renderHtml: function() {
			...
			return (
				'<div id="' + id + '" class="' + self.classes() + '" tabindex="-1">' +
					'<button class="btn btn-sm btn-text--dark" role="presentation" type="button" tabindex="-1">' +
		...
		renderHtml: function() {
			...
			return (
				'<div id="' + id + '" class="' + self.classes() + '">' +
					'<button role="presentation" hidefocus type="button" tabindex="-1" class="btn btn-sm btn-text--dark">' +
						(icon ? '<i class="' + icon + '"' + image + '></i>' : '') +
						'<span id="' + id + '-preview" class="' + prefix + 'preview"></span>' +
						(self._text ? (icon ? ' ' : '') + (self._text) : '') +
					'</button>' +
					'<button type="button" class="' + prefix + 'open btn btn-sm btn-text--dark" hidefocus tabindex="-1">' +
...
define("tinymce/ui/MenuButton", [
	...
	var MenuButton = Button.extend({
		...
		renderHtml: function() {
			...
			return (
				'<div id="' + id + '" class="' + self.classes() + '" tabindex="-1">' +
					'<button class="btn btn-sm btn-text--dark" id="' + id + '-open" role="presentation" type="button" tabindex="-1">' +
						(icon ? '<i class="' + icon + '"></i>' : '') +
...
define("tinymce/ui/SplitButton", [
	...
	return MenuButton.extend({
		...
		renderHtml: function() {
			...
			return (
				'<div id="' + id + '" class="' + self.classes() + '">' +
					'<button type="button" hidefocus tabindex="-1" class="btn btn-sm btn-text--dark">' +
						(icon ? '<i class="' + icon + '"></i>' : '') +
						(self._text ? (icon ? ' ' : '') + self._text : '') +
					'</button>' +
					'<button type="button" class="' + prefix + 'open btn btn-sm btn-text--dark" hidefocus tabindex="-1">' +
