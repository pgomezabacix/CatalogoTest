...
! function(a, b) {
    ...
    ! function() {
        ...
        b.prototype.init = function() {
            ...
            if (this.s.controls && this.$items.length > 1 && (d = '<div class="lg-actions"><div class="lg-prev lg-icon action-item action-item--light action-item__icon">' + this.s.prevHtml + '</div><div class="lg-next lg-icon action-item action-item--light action-item__icon">' + this.s.nextHtml + "</div></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (f = '<div class="lg-sub-html"></div>'), b = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + c + '</div><div class="lg-toolbar lg-group"><span class="lg-close lg-icon action-item action-item--light action-item__icon"></span></div>' + d + f + "</div></div>", a("body").append(b), this.$outer = a(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), g.setTop(), a(window).on("resize.lg orientationchange.lg", function() {
                setTimeout(function() {
                    g.setTop()
                }, 100)
            ...
            }, this.s.backdropDuration), this.s.download && this.$outer.find(".lg-toolbar").append('<a id="lg-download" target="_blank" download class="lg-download lg-icon action-item action-item--light action-item__icon"></a>'), this.prevScrollTop = a(window).scrollTop()
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            if (this.core.s.fullScreen) {
                ...
                a = '<span class="lg-fullscreen lg-icon action-item action-item--light action-item__icon"></span>', this.core.$outer.find(".lg-toolbar").append(a), this.fullScreen()
            }
...
! function(a, b) {
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            var a = this;
            a.core.s.toogleThumb && (a.core.$outer.addClass("lg-can-toggle"), a.$thumbOuter.append('<span class="lg-toogle-thumb lg-icon action-item"></span>'), a.core.$outer.find(".lg-toogle-thumb").on("click.lg", function() {
...
! function(a, b) {
    ...
    ! function() {
        ...
        d.prototype.init = function() {
            var b = this,
                c = '<span id="lg-zoom-in" class="lg-icon action-item action-item--light action-item__icon"></span><span id="lg-zoom-out" class="lg-icon action-item action-item--light action-item__icon"></span>';
            b.core.s.actualSize && (c += '<span id="lg-actual-size" class="lg-icon action-item action-item--light action-item__icon"></span>'), b.core.s.useLeftForZoom ? b.core.$outer.addClass("lg-use-left-for-zoom") : b.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(c), b.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(c, d, e) {
  ...
  (function () {
      ...
      Rotate.prototype.buildTemplates = function () {
          ...
          if (this.core.s.flipVertical) {
              rotateIcons += '<button aria-label="Flip vertical" class="lg-flip-ver lg-icon action-item action-item--light action-item__icon"></button>';
          }
          if (this.core.s.flipHorizontal) {
              rotateIcons += '<button aria-label="flip horizontal" class="lg-flip-hor lg-icon action-item action-item--light action-item__icon"></button>';
          }
          if (this.core.s.rotateLeft) {
              rotateIcons += '<button aria-label="Rotate left" class="lg-rotate-left lg-icon action-item action-item--light action-item__icon"></button>';
          }
          if (this.core.s.rotateRight) {
              rotateIcons += '<button aria-label="Rotate right" class="lg-rotate-right lg-icon action-item action-item--light action-item__icon"></button>';
          }
